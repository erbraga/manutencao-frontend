    ...
    <header className= 'w-full bg-radial-[at_0%_100%] from-slate-300 to-slate-100 p-1 border-b border-slate-400 shadow-xl sticky top-0 z-50'>
        <div className='w-full md:min-w-2xl md:max-w-5xl xl:min-w-6xl xl:max-w-7xl m-auto flex flex-row items-center justify-between'>
          <div className='flex flex-row items-center'>
            <IconePrincipal className="m-1 p-2 md:p-3 border rounded-full bg-indigo-900 text-white" />
          ...
          <div className='m-1 p-2 flex flex-row gap-2'>
            <div className='border border-slate-400 rounded-full flex flex-row'>
              <div>
                <IconeHome className="m-1 p-1 rounded-full  text-stone-500 hover:bg-slate-300 focus:bg-blue-700 focus:text-white " />
              </div>
              <div>
                <IconeItemManutencao className="m-1 p-1 rounded-full  text-stone-500 hover:bg-slate-300 focus:bg-blue-700 focus:text-white w-10" />
              </div>
              <div>
                <IconeVeiculo className="m-1 p-1 rounded-full text-stone-500 hover:bg-slate-300 focus:bg-blue-700 focus:text-white" />
              </div>
            </div>
